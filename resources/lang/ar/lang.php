...
return [
    ...
    "companies"=>"الشركات",
    "individuals"=>"الأفراد",
    "AddYourStore"=>"أضف متجرك",
    "EditYourStore"=>"تعديل متجرك",
    "AddYourPage"=>"أضف صفحتك",
    "EditYourPage"=>"تعديل صفحتك",
    "addStorePlaceholder" =>"قم بتعبئة جميع البيانات بالأسفل لإنشاء متجرك الخاص",
    "EditStorePlaceholder" =>"قم بتعبئة جميع البيانات بالأسفل لتعديل متجرك الخاص",
    ...
    "IAgreeTo" =>"أوافق علي",
    "Confirmandcreatestore"=>"إنشاء المتجر أو المطعم",
    "Confirmandeditstore"=>"تعديل المتجر أو المطعم",
    "namePlacholder" => "أدخل اسم متجرك أو مطعمك",
    "Store Desc Placeholder" => "أدخل وصف متجرك أو مطعمك",
